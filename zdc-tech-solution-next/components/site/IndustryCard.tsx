    ...
    >
      <SpotlightCard className="h-full">
        <div className="relative z-10 flex h-full flex-col items-center p-6 text-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-border bg-gradient-to-br from-primary/15 to-secondary/15 transition-transform duration-300 group-hover:scale-110">
